    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-one-paper-got-accepted-at-3dv-2026",
          title: 'One paper got accepted at 3DV 2026',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%7A%68%6F%75@%75%6E%69-%62%6F%6E%6E.%64%65", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/zero-4869", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/hongyu-zhou", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=RhDWEsgAAAAJ&hl", "_blank");
        },
      },{
      id: 'light-theme',
